...
useradd -u $RT_UID -g $RT_GID -d /home/rtorrent -m -s /bin/sh rtorrent
if [ $? != 0 ]; then
    adduser -u $RT_UID -G rtorrent -h /home/rtorrent -D -s /bin/sh rtorrent
fi
...
chown -R rtorrent:rtorrent /downloads/.rtorrent /downloads
